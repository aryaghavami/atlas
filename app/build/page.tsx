...
const STEPS = [
  { n: "1", title: "THE CONSTRAINT", what: "Three numbers, nothing else: net worth, your date, your runway. The constraint is the product.", prompt: "Scaffold a Next.js + TypeScript app called Atlas. One screen: a centered dark phone-frame (black, gold accents, Geist + a serif). It shows NET WORTH (big mono number), TARGET DATE (giant serif year + month), and RUNWAY (months), using representative placeholder numbers. No charts, no nav, no settings. Make it look like a $1000 product, not a default template." },
  ...
  return (
    <main style={{ minHeight: "100dvh", background: "radial-gradient(120% 70% at 50% -10%, rgba(212,175,55,0.07) 0%, rgba(0,0,0,0) 45%), #08080a", color: "#EFEBE3", padding: "56px 22px 96px" }}>
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        <a href="/" style={{ fontFamily: GEIST, fontSize: 13, color: "#908C83", textDecoration: "none" }}>‹ Atlas</a>
        ...
        <h1 style={{ fontFamily: SERIF, fontSize: 42, lineHeight: 1.08, margin: "12px 0 0", letterSpacing: "-0.01em" }}>Build Atlas yourself.<br /><span style={{ fontStyle: "italic", color: "#b8b3a8" }}>The full build, start to finish.</span></h1>
        ...
        <div style={{ marginTop: 40, padding: "20px 20px", borderRadius: 14, border: "1px solid rgba(217,178,124,0.25)", background: "rgba(217,178,124,0.05)" }}>
          ...
          <p style={{ fontFamily: GEIST, fontWeight: 300, fontSize: 14.5, lineHeight: 1.6, color: "#cfcabf", margin: "8px 0 14px" }}>
            Atlas is free, always. If you run a company and want a custom AI agent built for it, I take a few of those.
          </p>
